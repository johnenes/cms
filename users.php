...
//   Validate User Registration against errors in submission
     function validate_user_registrations(){
        ...
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            $user_role                  =  trim(clean($_POST['user_role']));
...
//***************************************Check for errors ************************************/
        ...
        /***************************************Diplay Errors Here************************************/
            ...
            if( register_user($first_name,$last_name,$username, $email,$password,$user_role)){
               set_message("<p class='bg-success text-white'>Please check your email or spam folder for activation link</p>");
                redirect("../index.php");
...
function register_user($first_name,$last_name,$username, $email,$password, $subscriber){
    ...
    $user_role                   =  trim(escape($user_role));
...
function login_user($email,$password ,$remember, $username){
...
function recovery_password(){ #recovery password function
    if ($_SERVER["REQUEST_METHOD"]=='POST') {
