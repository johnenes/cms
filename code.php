...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    </button>We have a sent a security code to your email <span>
        ...
        <div class="row">
            ...
            <?php  validation_code();  display_message();?>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <input type="submit" name="code_cancel" id="code-cancel" tabindex="2"
